...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_BRID, KC_VOLD, KC_MUTE, KC_VOLU, KC_TRNS, KC_TRNS,
                               KC_TRNS, T_GAME, KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS
  ),
  LAYOUT(
  ...
  LAYOUT(
    KC_TRNS, KC_TAB, KC_Q, KC_W, KC_E, KC_R,    KC_TRNS, KC_TRNS, KC_UP, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_LCTL, KC_A, KC_S, KC_D, KC_F,    KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_LSFT, ALT_Z, KC_X, KC_C, KC_V,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                               KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS
  )
};
